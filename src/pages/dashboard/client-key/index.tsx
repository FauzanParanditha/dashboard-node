...
const ClientKeyPage = () => {
  ...
  const canCreateClientKey = hasPermission("client-key:create");
  const canUpdateClientKey = hasPermission("client-key:update");
  const canDeleteClientKey = hasPermission("client-key:delete");
