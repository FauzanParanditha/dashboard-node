import DetailClntKey from "@/components/dashboard/client-key/detailClientKey";
...
const DetailClientKey = () => {
  useAuthGuard(["client-key:read"]);
  return (
    <>
      <DashboardLayout>
...
export default DetailClientKey;
